...
public class BugReportActivity extends AbsThemeActivity {
    ...
    private static final String ISSUE_TRACKER_LINK = "https://github.com/TheTerminatorOfProgramming/Cassette";
    ...
    private void sendBugReport(GithubLogin login) {
        ...
        GithubTarget target = new GithubTarget("TheTerminatorOfProgramming", "Cassette");
