...
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (widgetManager.getAppWidgetIds(new ComponentName(context, AppWidgetBig.class)).length > 0 ||
                ...
                widgetManager.getAppWidgetIds(new ComponentName(context, AppWidgetFull.class)).length > 0 ||
                widgetManager.getAppWidgetIds(new ComponentName(context, AppWidgetMini.class)).length > 0) {
