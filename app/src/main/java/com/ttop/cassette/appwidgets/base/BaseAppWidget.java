...
public abstract class BaseAppWidget extends AppWidgetProvider {
    ...
    protected void defaultAppWidget(final Context context, final int[] appWidgetIds) {
        ...
        appWidgetView.setTextColor(R.id.title, context.getResources().getColor(PreferenceUtil.getWidgetTextColorFromPrefValue(PreferenceUtil.getInstance().getAppTheme())));
        appWidgetView.setTextColor(R.id.text, context.getResources().getColor(PreferenceUtil.getWidgetTextColorFromPrefValue(PreferenceUtil.getInstance().getAppTheme())));
    ...
    protected void setTitlesArtwork(final MusicService service, String lineType) {
        final Song song = service.getCurrentSong();
