 ...
 */
package com.ttop.cassette.volume
...
class AudioVolumeObserver(private val context: Context) {
    ...
    private var contentObserver: com.ttop.cassette.volume.AudioVolumeContentObserver? = null
    ...
    fun register(audioStreamType: Int, listener: OnAudioVolumeChangedListener) {
        ...
        contentObserver = com.ttop.cassette.volume.AudioVolumeContentObserver(
            handler,
            mAudioManager,
            audioStreamType,
            listener
