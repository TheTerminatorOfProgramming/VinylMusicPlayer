...
public final class PreferenceUtil {
    ...
    public static final String HEADSET_AUTOPLAY = "headset_autoplay";

    public static final String BLUETOOTH_AUTOPLAY = "bluetooth_autoplay";
    ...
    public static final String LOCKSCREEN_CONTROLS = "lockscreen_controls";

    public static final String NEXT_PREV_BUTTONS = "next_prev_buttons";
    ...
    public static final String BLUETOOTH_DELAY = "bluetooth_delay";
    ...
    public void setBluetoothAutoplay(boolean value) {
        mPreferences.edit()
                .putBoolean(BLUETOOTH_AUTOPLAY, value)
                .apply();
    }

    public boolean getBluetoothAutoplay(){
        return mPreferences.getBoolean(BLUETOOTH_AUTOPLAY, false);
    }

    public void setHeadsetAutoplay(boolean value) {
        mPreferences.edit()
                .putBoolean(HEADSET_AUTOPLAY, value)
                .apply();
    }

    public boolean getHeadsetAutoplay(){
        return mPreferences.getBoolean(HEADSET_AUTOPLAY, false);
    }
    ...
    public void setCurrentPlay(boolean value){
        mPreferences.edit()
                .putBoolean(CURRENT_PLAY, value)
                .apply();
    }

    public boolean getCurrentPlay(){
        return mPreferences.getBoolean(CURRENT_PLAY, false);
    }

    public void setLockscreenControls(boolean value) {
        mPreferences.edit()
                .putBoolean(LOCKSCREEN_CONTROLS, value)
                .apply();
    }

    public boolean getLockscreenControls(){
        return mPreferences.getBoolean(LOCKSCREEN_CONTROLS, false);
    }

    public void setNextPrevButtons(boolean value) {
        mPreferences.edit()
                .putBoolean(NEXT_PREV_BUTTONS, value)
                .apply();
    }

    public boolean getNextPrevButtons(){
        return mPreferences.getBoolean(NEXT_PREV_BUTTONS, false);
    }
    ...
    public void setPodcastApp(String app){
        final SharedPreferences.Editor editor = mPreferences.edit();
        editor.putString(PODCAST, app);
        editor.apply();
    }

    public String getPodcastApp(){
        return mPreferences.getString(PODCAST, "");
    }
    ...
    public void setBluetoothDelay(String value) {
        mPreferences.edit()
                .putString(BLUETOOTH_DELAY, value)
                .apply();
    }

    public String getBluetoothDelay(){
        return mPreferences.getString(BLUETOOTH_DELAY, "2");
    }
}